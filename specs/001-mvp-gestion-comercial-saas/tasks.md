...
- [ ] T001: Inicializar pnpm workspaces, Turborepo y scripts raíz con una prueba smoke del workspace [RF-151]
- [ ] T002: Crear configuración TypeScript estricta, ESLint y Vitest compartida y verificarla sobre un paquete mínimo [RF-151]
- [ ] T003: Crear el esqueleto NestJS con `/api/v1` y una prueba Supertest de arranque [RF-135, RF-151]
- [ ] T004: Crear el esqueleto Next.js App Router con una prueba de render responsive del shell mínimo [RF-152]
...
- [ ] T021: Crear audit_events append-only con allowlist y trigger defensivo de UPDATE/DELETE [RF-140, RF-141]
...
- [ ] T026: Agregar pipe Zod, paginación por cursor, límites, filtros allowlist y snapshot OpenAPI [RF-133, RF-151]
...
- [ ] T029: Crear users globales con email normalizado único y password hash versionado Argon2id [RF-10, RF-12]
- [ ] T030: Implementar login no enumerable con sesión opaca y hash SHA-256 del token [RF-10, RF-12]
- [ ] T031: Emitir cookie __Host-uco_session con atributos seguros y probar que nunca expone el token persistido [RF-12, RF-151]
...
- [ ] T039: Preparar el pool/rol restringido y el contrato interno de provisioning sin exponer todavía la mutación [RF-284]
- [ ] T040: Exponer provisioning asistido que cree atómicamente organización argentina en ARS, primera sucursal, primer OWNER y auditoría; probar rollback total [RF-01, RF-05, RF-178, RF-284] (Depende de T039)
- [ ] T041: Implementar recuperación OWNER excepcional explícita, mínima y auditada [RF-183, RF-284]
- [ ] T042: Descubrir con acceso global mínimo las membresías del usuario autenticado y seleccionar organización activa solo entre las vigentes, sin permitir enumeración tenant [RF-03, RF-04]
- [ ] T043: Implementar perfil organizacional editable por OWNER/ADMIN sin campos estructurales [RF-08]
- [ ] T044: Cambiar timezone por OWNER conservando timestamps históricos absolutos [RF-09, RF-271]
- [ ] T045: Preparar política interna de cambio de moneda solo para OWNER sin historial, sin exponer aún la mutación [RF-07, RF-205]
- [ ] T046: Definir y probar el predicado de historial servidor que bloquea moneda desde la primera referencia, incluso anulada o revertida [RF-06, RF-206]
...
- [ ] T057: Activar un OWNER invitado únicamente después de aceptar [RF-179]
- [ ] T058: Rechazar concurrentemente toda mutación que deje una organización activa sin OWNER [RF-178, RF-181]
- [ ] T059: Permitir modificar otro OWNER solo si queda al menos uno activo [RF-182]
- [ ] T060: Limitar la gestión ADMIN a miembros no propietarios y branches dentro de su alcance [RF-18, RF-184]
- [ ] T061: Revocar membresía guardando momento efectivo y conocimiento por dispositivo [RF-19, RF-20]
- [ ] T062: Crear sucursal con nombre normalizado único dentro del tenant [RF-27, RF-266]
- [ ] T063: Implementar modelo de estado de sucursal e impedir nuevas operaciones sobre una sucursal inactiva, sin exponer aún el comando de desactivación [RF-29]
...
- [ ] T073: Normalizar y reservar SKU opcional único entre registros activos e inactivos [RF-36, RF-265]
- [ ] T074: Normalizar y reservar barcode opcional único entre registros activos e inactivos [RF-36, RF-265]
- [ ] T075: Crear y probar el componente de captura de barcode como entrada de teclado, sin depender todavía del flujo de confirmación POS [RF-38, RF-153]
- [ ] T076: Mostrar advertencia de nombres similares sin bloquear el alta [RF-37]
- [ ] T077: Cambiar precio vigente conservando versiones y precios históricos [RF-46]
- [ ] T077A: Crear versiones firmadas, exposiciones por dispositivo/grant/época y recursos con FKs tenant; impedir purga de versiones con historia o incertidumbre [RF-167, RF-169, RF-170, RF-302, RF-304, RF-307]
- [ ] T077C: Implementar predicados internos de historial/incertidumbre por recurso y bloqueo permanente de moneda al declarar irrecuperable con posible historial desconocido; probar que reaparición/revocación/expiración no lo levantan [RF-302, RF-304, RF-305, RF-306] (Depende de T077A)
- [ ] T077D: Implementar contrato servidor de barrera por época y checkpoint: verificar ACKs/continuidad, cerrar autorizaciones antiguas y coordinar locks con lifecycle/grants; probar múltiples dispositivos, checkpoint obsoleto y carreras en PostgreSQL [RF-131, RF-132, RF-302, RF-303] (Depende de T077A y T077C)
- [ ] T077B: Exponer cambio de moneda por OWNER solo sin historia ni incertidumbre offline y sin bloqueo permanente, coordinado con primera operación y emisión de grants; auditoría/idempotencia atómicas [RF-06, RF-07, RF-131, RF-132, RF-205, RF-206, RF-302, RF-303, RF-305] (Depende de T045–T046, T077A, T077C y T077D)
- [ ] T078: Desactivar ítem con historia e impedir uso nuevo sin alterar snapshots [RF-55, RF-56]
- [ ] T079: Preparar borrado físico de ítems/maestros solo sin referencias ni exposiciones offline relevantes; probar autorización y rechazo ante incertidumbre [RF-54, RF-55, RF-302, RF-304, RF-306] (Depende de T077C y T077D)
- [ ] T080: Preparar cambio de type, trackInventory y baseUnit solo sin historia ni incertidumbre y con combinación válida; revalidar barrera/versiones bajo lock [RF-159, RF-160, RF-302, RF-303, RF-306] (Depende de T077C y T077D)
- [ ] T081: Permitir desactivación conservando referencias/versiones; para cambiar semántica bloqueada, usar otro ítem sin reasignar historia ni liberar incertidumbre del anterior [RF-159, RF-161, RF-304, RF-306]
- [ ] T081A: Exponer lifecycle de categorías/ítems con permisos, barrera D01, locks, auditoría e idempotencia; probar rollback y carrera con primera referencia [RF-53, RF-54, RF-55, RF-56, RF-131, RF-132, RF-159, RF-160, RF-161, RF-302, RF-303, RF-306] (Depende de T069 y T077A–T081)
